...
public abstract class Code {
	...
	private static final Hashtable<String, String> compTable = new Hashtable<String, String>() {{
		...
		put("-D", "110001111");
		put("-A", "110110011");
		put("D+1", "110011111"); put("1+D", "110011111");
		put("A+1", "110110111"); put("1+A", "110110111");
		put("D-1", "110001110");
		put("A-1", "110110010");
		put("D+A", "110000010"); put("A+D", "110000010");
		put("D-A", "110010011");
		put("A-D", "110000111");
		put("D&A", "110000000"); put("D&A", "110000000");
		put("D|A", "110010101"); put("A|D", "110010101");
		
		// when a = 1
		put("M", "111110000");
		put("!M", "111110001");
		put("-M", "111110011");
		put("M+1", "111110111"); put("1+M", "111110111");
		put("M-1", "111110010");
		put("D+M", "111000010"); put("M+D", "111000010");
		put("D-M", "111010011");
		put("M-D", "111000111");
		put("D&M", "111000000"); put("M&D", "111000000");
		put("D|M", "111010101"); put("M|D", "111010101");
